...
import { HashicorpVault } from '../lib/hashicorp-vault';
import { mockHashicorpVault } from '../lib/hashicorp-vault/mocks';
import { HashicorpVaultSigningManager, VaultSigner } from '../lib/hashicorp-vault-signing-manager';

jest.mock('~/lib/hashicorp-vault', () => ({
  // eslint-disable-next-line @typescript-eslint/naming-convention
  HashicorpVault: function () {
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    return require('~/lib/hashicorp-vault/mocks').mockHashicorpVault;
  },
}));
